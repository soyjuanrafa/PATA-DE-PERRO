...
export const WelcomeAuthModal: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] w-full bg-stone-900 flex items-center justify-center p-4">
      {/* Background Mask Image (Traditional Nicaragua Masks) */}
        ...
        <AnimatePresence mode="wait">
          ...
          {viewState === 'welcome' && (
            <motion.div
              ...
              className="flex flex-col items-center justify-center min-h-[480px] space-y-6"
            >
              <div className="text-center space-y-2 mb-8">
                <span className="bg-orange-500/90 text-white text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full border border-orange-400/30">
                  Ciudades Creativas de Nicaragua
                </span>
                <h2 className="text-white text-3xl font-black tracking-tight pt-2">
                  Pata de Perro
                </h2>
                <p className="text-stone-300 text-sm">
                  Descubre, planifica y apoya el turismo local
                </p>
              </div>
              ...
              <button
                ...
                className="w-full py-4 rounded-full bg-orange-500 hover:bg-orange-600 text-white font-extrabold text-lg tracking-wider uppercase shadow-xl transition-all transform active:scale-98 text-center"
              >
                REGISTRARSE
              </button>
              ...
              <button
                ...
                className="w-full py-4 rounded-full bg-transparent hover:bg-white/10 text-orange-400 font-extrabold text-lg tracking-wider uppercase border-2 border-white text-center transition-all transform active:scale-98"
              >
                INICIAR SESIÓN
              </button>
              ...
              <button
                ...
                className="text-stone-300 hover:text-white text-xs font-semibold underline underline-offset-4 pt-4"
              >
          ...
          {viewState === 'register' && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -30 }}
              className="bg-[#faf6f0] rounded-[2.5rem] p-8 sm:p-10 shadow-2xl border border-amber-100 space-y-6 text-stone-800"
            >
              <h2 className="text-stone-900 text-2xl font-black tracking-tight text-center uppercase">
                REGISTRARSE
              </h2>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-full bg-white border border-stone-200 text-sm focus:outline-hidden focus:ring-2 focus:ring-orange-500"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-stone-600 mb-1">Correo</label>
                  <input
                ...
                <div>
                  <label className="block text-xs font-bold text-stone-600 mb-1">Contraseña</label>
                  <input
                ...
                <button
                  ...
                  type="submit"
                  className="w-full py-3.5 mt-2 rounded-full bg-orange-500 hover:bg-orange-600 text-white font-extrabold text-base tracking-wider uppercase shadow-lg transition-all"
                >
                  REGISTRARSE
                </button>
              </form>
              ...
              <div className="text-center space-y-3 pt-2">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <button
                    ...
                    className="w-12 h-12 rounded-full bg-white shadow-md border border-stone-200 flex items-center justify-center hover:bg-stone-50 transition-colors"
                    title="Google"
                  >
                  ...
                  <button
                    ...
                    className="w-12 h-12 rounded-full bg-stone-900 shadow-md text-white flex items-center justify-center hover:bg-stone-800 transition-colors"
                    title="Apple"
                  >
                  ...
                  <button
                    ...
                    className="w-12 h-12 rounded-full bg-[#1877F2] shadow-md text-white flex items-center justify-center hover:opacity-90 transition-opacity"
                    title="Facebook"
                  >
                ...
                <div className="pt-2">
                  <button
                    onClick={() => setViewState('login')}
                    className="text-stone-700 text-xs font-semibold hover:underline"
                  >
